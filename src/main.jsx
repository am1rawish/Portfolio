...
const projects = [
  {
    ...
    githubHref: "https://github.com/am1rawish/CPSC584-Project",
    link: "#contact",
  ...
  },
  {
    ...
    githubHref: "https://github.com/Cthomson20/movie_theatre_system",
    link: "#contact",
  ...
  },
  {
    ...
    githubHref: "https://github.com/am1rawish/CPSC525-Final-Project",
    link: "#contact",
    label: "Ask about future project",
    action: "Ask about this project",
  ...
  },
  {
    ...
    githubHref: "https://github.com/am1rawish/Portfolio",
    link: "#contact",
    label: "Ask about project placeholder",
    action: "Ask about this project",
    githubLabel: "View Project Placeholder GitHub repository"
...
function Background() {
  return (
    <section className="section background-section" id="background">
      ...
      <div className="section-copy">
        <p>
          I'm a computer science student at the University of Calgary currently in the 4th year of my degree. 
          ...
          to elementary and high school students. In the third year of my degree, I had the opportunity to 
